...
def encontrar_palabra_mas_larga(texto):
    print("Encuentra la palabra más larga en el texto")
...
def es_palindromo(texto):
    print("Verifica si un texto es palíndromo (se lee igual al revés)")
