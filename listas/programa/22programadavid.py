def sumar(a, b):
    print("Suma dos números y devuelve el resultado")
    resultado = a + b
    return resultado

def restar(a, b):
    print("Resta b de a y devuelve el resultado")
    resultado = a - b
    return resultado

def multiplicar(a, b):
    print("Multiplica dos números y devuelve el resultado")
    resultado = a * b
    return resultado

def dividir(a, b):
    print("Divide a entre b y devuelve el resultado")
